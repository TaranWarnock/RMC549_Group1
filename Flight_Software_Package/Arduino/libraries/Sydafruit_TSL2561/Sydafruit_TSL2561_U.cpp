 ...
 *
 * Modified by Syd Ullrich for Usask RMC549 (new code is marked)
 */
/**************************************************************************/
...
Adafruit_TSL2561_Unified::Adafruit_TSL2561_Unified(uint8_t addr, int32_t sensorID)
{
  ...
  _tsl2561AutoGain = false;
	_tsl2561Counting = 0; //added by syd to work with public startCount and endCount
...
/*Syd made this************************************************************/
/*!
    @brief      Sets the integration time and the gain for the TSL2561. 
		            Higher time means more light captured (better for low light 
								conditions) but will take longer to run readings. 
								High gain mode just bit-shifts the sensor readings.
		@param gain The value we'd like to set the gain to
    @param time The amount of time we'd like to add up values
*/
/**************************************************************************/
void Adafruit_TSL2561_Unified::setGainTime(tsl2561Gain_t gain, tsl2561IntegrationTime_t time)
{
  if (!_tsl2561Initialised) begin();
  ...
  /* Update the timing register */
  write8(TSL2561_COMMAND_BIT | TSL2561_REGISTER_TIMING, time | gain);
...
/*Syd made this**************************************************************/
/*!
    Marks time for start of integration
*/
/**************************************************************************/
void Adafruit_TSL2561_Unified::startCount(unsigned long time)
{
	enable();
	_tsl2561Counting=time;
}

/*Syd made this**************************************************************/
/*!
    Like getData without the delay, for use with 'Counting'
*/
/**************************************************************************/
void Adafruit_TSL2561_Unified::readADC(uint16_t *broadband, uint16_t *ir)
{
