...
#ifndef SYDAFRUIT_TSL2561_H_
#define SYDAFRUIT_TSL2561_H_
...
class Adafruit_TSL2561_Unified : public Adafruit_Sensor {
 public:
  ...
  void setGain(tsl2561Gain_t gain);
	//V added by syd to do one-line config V
	void setGainTime(tsl2561Gain_t gain, tsl2561IntegrationTime_t time);//it's 1 write to register command
  ...
  tsl2561Gain_t _tsl2561Gain;
	unsigned long _tsl2561Counting;
	void startCount(unsigned long time); //writes time to 'counting'
	void readADC(uint16_t *broadband, uint16_t *ir); //read the ADC and sets 'Counting' to 0
